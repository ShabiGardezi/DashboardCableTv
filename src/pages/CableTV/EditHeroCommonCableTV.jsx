...
const EditHeroCommonCableTV = () => {
  ...
  const [data, setData] = useState({
    heading: "CableTv_Section.HeroCommon.heading",
    description: "CableTv_Section.HeroCommon.description",
  });
  ...
  return (
    <>
      <Toaster />
      <VerticalNavbar />
      <HeaderCommon title="CableTv Page => Hero Common Section" />
      <Container>
...
export default EditHeroCommonCableTV;
