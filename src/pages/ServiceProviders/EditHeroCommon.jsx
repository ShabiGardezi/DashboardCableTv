...
const EditHeroSection = () => {
  ...
  const [data, setData] = useState({
    heading: "ServiceProviders.HeroCommon.heading",
    description: "ServiceProviders.HeroCommon.description",
  });
  ...
  return (
    <>
      <Toaster />
      <VerticalNavbar />
      <HeaderCommon title="Service Provider Page => Hero Common Section" />
      <Container>
