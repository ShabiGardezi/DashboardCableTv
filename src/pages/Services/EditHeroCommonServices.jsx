...
const EditHeroCommonServices = () => {
  ...
  const [data, setData] = useState({
    heading: "Services.HeroCommon.heading",
  ...
  return (
    <>
      <Toaster />
      <VerticalNavbar />
      <HeaderCommon title="Services Page => Hero Common Section" />
      <Container>
...
export default EditHeroCommonServices;
