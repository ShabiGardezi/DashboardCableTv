...
const EditHeroCommonSatelliteInternet = () => {
  ...
  const [data, setData] = useState({
    heading: "SatelliteInternet_Section.HeroCommon.heading",
    description: "SatelliteInternet_Section.HeroCommon.description",
  });
  ...
  return (
    <>
      <Toaster />
      <VerticalNavbar />
      <HeaderCommon title="Satellite Internet Page => Hero Common Section" />
      <Container>
...
export default EditHeroCommonSatelliteInternet;
